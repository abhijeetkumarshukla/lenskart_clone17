...
const ProductTemplate = ({src , rating , userRated , price , name ,shape , color ,mprice , product , id}) => {
  ...
  return (
    <GridItem >
    <Box onClick={()=>(veiwPage())} position="relative" border="1px solid" m={'auto'} borderColor="gray.300" w={'80%'} borderRadius="3%" p="10px" _hover={{boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px"}}>
